...
(define-key evil-normal-state-map (kbd "C-M-<right>") #'next-buffer)
(define-key evil-normal-state-map (kbd "C-M-<left>") #'previous-buffer)
...
(define-key evil-normal-state-local-map (kbd "SPC o a") #'helm-org-agenda-files-headings)
